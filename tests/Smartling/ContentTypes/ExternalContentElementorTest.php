...
class ExternalContentElementorTest extends TestCase {
        ...
        return [
            ...
            [
                ...
                [
                    ...
                    '590657a/b56da210f3ad3c/0088b31/editor' => '<p>Middle text</p>',
                    '590657a/b56da210f3ad3c8798127/78d53a1/title' => 'Right heading',
                ],
            ]
        ];
    }
    ...
    private function getExternalContentElementor(?WordpressFunctionProxyHelper $proxy = null): ExternalContentElementor
    {
        ...
        return new ExternalContentElementor($proxy);
    }
    ...
    public function testMergeElementorData()
    {
        ...
        $this->assertEquals(
            ...
            '590657a/b56da210f3ad3c/0088b31/editor' => '<p>Middle text translated</p>',
            '590657a/b56da210f3ad3c8798127/78d53a1/title' => 'Right heading translated',
