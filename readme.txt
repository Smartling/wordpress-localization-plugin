...
== Changelog ==
= 2.16.8 =
* Fixed translation lock screen locking unintended submissions (backport of 3.1.2 fix)
* Removed deprecated post content block level locking from translation lock screen (backport of 3.0.0 change)
