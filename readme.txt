...
= 5.6.2 =
* Improved upload queue processing to avoid silently skipping uploads

= 5.6.1 =
* Fixed upload widget not displaying
...
= 5.3.4 =
* Added support for Elementor mega-menu widget
...
= 5.3.1 =
* Fixed invalid credentials preventing settings page from loading
...
* Added support for Elementor image carousel widget
* Added support for icons in Elementor button widgets

= 5.1.2 =
* Proper release for 5.1.1

= 5.1.1 =
* Further improved performance when working on installations with a large number of ACF fields

= 5.1.0 =
* Added Related assets UI on the Bulk Submit page
