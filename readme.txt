...
== Changelog ==
= 3.10.0 =
* Reverted daily bucket job upload to pre 3.9.0 behaviour. When automatically uploaded, modified content should be added to the last job the content was added to when uploading manually.
