...
== Changelog ==
= 3.12.0 =
* Improved compatibility with WP Admin Audit plugin while working in php strict mode by not firing the `wp_after_insert_post` hook on target post creation
