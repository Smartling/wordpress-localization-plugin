...
== Changelog ==
= 2.5.1 =
* Fix WordPress fatal error on plugin activation

= 2.5.0 =
* Add support for MultilingualPress3. On creating submissions Smartling connector will also add content relations for MLP3.
