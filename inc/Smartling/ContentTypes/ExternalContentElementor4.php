...
class ExternalContentElementor4 extends ExternalContentAbstract implements ContentTypeModifyingInterface, ExternalContentElementorInterface
{
    use LoggerSafeTrait;

    public const META_FIELD_NAME = '_elementor_data';
    ...
    public function __construct(
        ...
        private ElementFactory4 $elementFactory,
