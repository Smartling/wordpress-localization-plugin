...
class SubmissionsPageController extends WPAbstract implements WPHookInterface
{
    ...
    public function __construct(LocalizationPluginProxyInterface $connector, PluginInfo $pluginInfo, EntityHelper $entityHelper, SubmissionManager $manager, Cache $cache, Queue $queue)
    {
