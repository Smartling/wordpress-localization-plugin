        ...
        <div class="update-nag">
            ...
            <div class="toggleExpert hidden">
                <table>
                    ...
                    <tr>
                        <th><label for="<?= GlobalSettingsManager::SETTING_CUSTOM_DIRECTIVES?>"><a href="https://help.smartling.com/hc/en-us/articles/360008000893-XML#directives"><?= __('Custom directives.')?></a><?= __('XML processor will wrap each line from the text area in') ?><pre>&lt;!-- smartling.%%line%% --&gt;</pre>. <?= __('Invalid directives WILL BREAK PROCESSING.')?></label></th>
                        <td>
